// Global variables
var baseAttack = 0; //original attack 
...
function initCharacters() {
    var Amseti = new Character("Amseti", 100, 10, 5, "./assets/images/Amseti,.jpg");
    var Hapy = new Character("Hapy", 200, 50, 30, "./assets/images/Hapy.jpg");
    var Duamutef = new Character("Duamutef", 150, 15, 2, "./assets/images/Duamutef.jpg");
    var Qebehsenuef = new Character("Qebehsenuef", 180, 30, 12, "./assets/images/Qebehsenuef.jpg");
    charArray.push(Amseti, Hapy, Duamutef, Qebehsenuef);
}
